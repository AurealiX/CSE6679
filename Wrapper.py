...
class TPSolverGUI:
    def __init__(self, root):
        ...
        self.models = {
            'VAM_CPU': {'degree': 4, 'params': [2.89882053e-06, 6.60235327e-10, 1.33673947e-07, 1.02655533e-09, 8.23809796e-12]},
            'VAM_GPU': {'degree': 2, 'params': [6.12819325e-02, 8.13568343e-04, 1.76353133e-06]},
            'LCM_CPU': {'degree': 3, 'params': [1.44470709e-09, 4.31753013e-09, 2.54599617e-08, 9.10828686e-10]},
            'LCM_GPU': {'degree': 1, 'params': [0.00931426, 0.00035132]},
            'MODI_CPU': {'degree': 4, 'params': [3.86394103e-15, 4.09111499e-25, 4.40157748e-18, 2.55315474e-08, 1.81581527e-10]},
            'MODI_GPU': {'degree': 4, 'params': [1.43214533e-16, 6.92095198e-03, 4.47117373e-06, 3.05181530e-22, 1.12619933e-10]},
            'SSM_CPU': {'degree': 4, 'params': [1.52529707e-26, 6.45845353e-27, 3.54214324e-26, 8.15851781e-26, 3.36453650e-07]},
            'SSM_GPU': {'degree': 4, 'params': [1.10099432e-14, 1.94897356e-14, 1.28397867e-17, 1.64337057e-08, 2.66689923e-10]}
        }
